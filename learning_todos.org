...
* Todo Basics
  ...
  *** Sub Topic 2
  ...
  This is now recognized by org as a TODO that needs doing. You realize that your todos are right in the middle of your
  meeting notes. You are going to need to take those out of your notes and add them to your todo list? Actually you don't need to.

  Org expects that your todos appear all over your notes. Org has the concept of the agenda and filtered todo lists to make
  managing your todos a reality. When OrgExtended starts up, it parses all valid files in your orgDir to build your agenda.

  OrgExtended will parse these files in the background as org starts up. The more files you have in your active list, the longer initialization
  ...
  NOTE: As you open files that are NOT in your orgDirs they will get added to the active set that are not actively excluded. This can surprise people
        as these files may have todos that appear on lists when you visit one of those files.

  So at this point, org will find your todos. Sometimes it helps to add meta data to your work to give context to that work.
